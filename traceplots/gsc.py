...
class GscNet():
    ...
    def plot_tree_actC_trace(
        ...
        windows=None, add_q_trace=False, top_k=None, lty=None,
        ...
        if lty is not None:
            custom_Lcycler = cycler(linestyle=lty)
            ax.set_prop_cycle(custom_Lcycler)     

        if lty is not None and colors is not None:
            custom_LCcycler = cycler(linestyle=lty,color=colors)
            ax.set_prop_cycle(custom_LCcycler)     
        ...
        for lv in range(1, max_sent_len + 1):
            ...
            for pos in range(1, max_sent_len - lv + 2):
                ...
                labs = '{}\n----\n{}'.format(
                 ...
                 #for top 4:
                 #labs = '{}\n{}\n{}\n{}'.format(
                    #self.filler_names[fidx[0]], self.filler_names[fidx[1]],self.filler_names[fidx[2]], self.filler_names[fidx[3]])
